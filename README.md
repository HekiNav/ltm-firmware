# Live Train Map Firmware
All the software used by the live train maps: [Helsinki](https://github.com/HekiNav/helsinki-live-train-map) and [Finland](https://github.com/HekiNav/finland-live-train-map)
